...
class TivixLabsPage(BasePage):
    ...
    def wait_for_page_to_be_loaded(self):
        self._actions.wait_for_element_to_be_displayed(self, TivixLabsLocators.rental_form)
        self._actions.wait_for_element_to_be_displayed(self, TivixLabsLocators.rental_country)
    ...
    def choose_drop_off_date(self, end_date):
        self._actions.set_element_value(TivixLabsLocators.rental_pickup_date, end_date)
